...
class Customer(models.Model):
    ...
    status = models.CharField("状态", choices=enroll_status_choices, max_length=64, default="unregistered",
                              help_text="选择客户此时的状态")
    network_consult_note = models.TextField(blank=True, null=True, verbose_name='网络咨询师咨询内容')  # 详细名称
    ...
    network_consultant = models.ForeignKey('UserProfile', blank=True, null=True, verbose_name='咨询师',
                                           related_name='network_consultant')  # 别名
    # 外键关联
...
class UserProfile(AbstractBaseUser, PermissionsMixin):
    ...
    REQUIRED_FIELDS = ['name']  # auth制定出了上面两个配置项的字段还有那些字段是必填
